...
CREATE TABLE IF NOT EXISTS reservoirs (
    ...
    level_dam_top DECIMAL(10,2),
    level_flood_high DECIMAL(10,2),
    level_dead DECIMAL(10,2),
    level_flood_limit_back DECIMAL(10,2),
    level_flood_operation DECIMAL(10,2),
    level_land_acquisition DECIMAL(10,2),
    level_resettlement DECIMAL(10,2),
    level_flood_storage_limit DECIMAL(10,2),
    functions TEXT,
